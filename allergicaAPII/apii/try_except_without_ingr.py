...
#         # Optional: handle the error here if needed
#         return RequestResult(state.error_code, state.message, response)

# def load_foods_data():
#     try: 
#         food_csv = pd.read_csv('C:\\Users\\add\\allergicapii\\apii\\RecipeMaterials.csv', index_col='recipe_id')
        
#         print("&&&&&&&&&&&&&&&&&&&&&&","we came in here",food_csv)
...
#         suggested_recipes_list = sorted_suggested_recipes.head(num_suggestions)
#         print("suggested_recipes_list", suggested_recipes_list)
#         df = pd.DataFrame(suggested_recipes_list)
#         suggested_recipes_json = df.to_json(orient='records')
#         parsed_suggested_recipes = json.loads(suggested_recipes_json)
        
#         print("kdsfjgvdoikbhvdfo",parsed_suggested_recipes)


#         print(type(parsed_suggested_recipes),"############################")

#         return OperationResult.set_status(Statuses.OK, parsed_suggested_recipes)
#         # return parsed_suggested_recipes
#     except Exception as error:
#         print(f"Error: {error}")
#         return OperationResult.set_status(Statuses.ENCODING_ERROR, str(error))

# # Testing the function
# desired_ingredients = 'mt-garlic,mt-tomatoes,mt-eggplant'
...
# #     # print("suggest_recipes_result $$$$$$$$$$$",suggest_recipes_result.data)
# #     status_message = suggest_recipes_result.status_message
# #     return suggest_recipes_result({"statusCode":suggest_recipes_result.status_code.value,  # Getting the value of the status code
# #         "data": suggest_recipes_result.data,
# #         "message": status_message })

# def api_result(desired_ingredients, allergic_ingredients):
#     suggest_recipes_result = suggest_recipes(desired_ingredients, allergic_ingredients)
#     print("dfdfdfdfdfdfdfdf",suggest_recipes_result.data)
#     # print("suggest_recipes_result $$$$$$$$$$$", suggest_recipes_result.data)
#     status_message = suggest_recipes_result.status_message
#     return {
